...
3) GenerateMap чтоб наконец запоминал хотя бы путь. Или кнопку рядом OpenFolderDialog
FIXED 4) скролинг не правильно работает.
5) отрисовывать раз в 1/30 секунды
FIXED 6) Поправить Main Menu / Load Map
